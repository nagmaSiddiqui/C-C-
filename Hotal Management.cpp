...
int main()
{
	...
	int choice=0,pchoice,pchoice1, quantity;// time=40;//choice means choice what you want ,pchoiceis flavour of which type you want and quantity for how much you want//pchoice1-size
	beginning:
		system("CLS");
